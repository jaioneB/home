...
const Publications = ({ heading, message, resume }) => {
  ...
  const publications = [
    ...
    { title: "Rodrigo Agerri, Jeremy Barnes, Jaione Bengoetxea, Blanca Calvo Figueras, Joseba Fernandez de Landa, Iker García-Ferrero, Olia Toporkov, and Irune Zubiaga. 2024. HiTZ@ Disargue: Few-shot Learning and Argumentation to Detect and Fight Misinformation in Social Media. In Proceedings of the Seminar of the Spanish Society for Natural Language Processing: Projects and System Demonstrations (SEPLN-CEDI-PD 2024), pages 118-123, A coruña, Spain", link: "https://ceur-ws.org/Vol-3729/p28_rev.pdf" },
